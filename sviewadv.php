			...
			<td>Account Name: </td><td><input type="text" name="acc_name" value="<?php echo $acc_name;?>"></td></tr>
			 ...
			 <tr><td> Account Type:</td><td><input type="text" name="acc_type" value="<?php echo $acc_type; ?>"></td></tr>
			  ...
			  <tr><td>  IFSC Code:</td><td><input type="text" name="ifsc" value="<?php echo $ifsc; ?>"></td></tr>
			   ...
			   <tr><td>  Amount:</td><td><input type="text" name="baddress" value="<?php echo $amt; ?>"></td></tr>
<?php			    
}
...
echo '</td>';
$sql=$conn->query("select * from owner where num='$num'");
if($sql->num_rows >0)
{
	while($uid=mysqli_fetch_assoc($sql))
	{
		$uidno=$uid['no'];
	}
}
echo'<td><a href="admin_renterview.php?id='.$uidno.'" name="vrent">View Renter</a>';
...
?>
<td colspan="2"><input type="submit" name="sviewadvsubmit" value="Edit" action="advediting.php" ></td></tr>
...
if($catno=='1')
{
echo'<tr><td colspan="2"><a href="admin_home.php?id='.$s.'">back to home</a></td>';
}
else if($catno=='3')
{
  echo'<tr><td colspan="2"><a href="renter_home3.php?id='.$s.'">back to home</a></td>';

}
else
{
  echo'<tr><td colspan="2"><a href="owner_home3.php?id='.$s.'">back to home</a></td>';
}
