      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo m-0 p-0"><a href="index.html" class="mb-0">YOURDREAMHOME</a></h1>
          </div>
        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-6 mt-lg-5 text-center">
              <h1 class="text-shadow">Rental houses</h1>
              ...
              <p><a href="login1.php" target="_blank" class="btn btn-primary px-5 py-3">Get Started</a></p>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-7 text-left">
            <h2 class="section-title mb-3">Rental firm workers</h2>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="team-member">
              ...
              <div class="p-3 bg-primary">
                ...
                <span class="position">Rental firm worker</span>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4 text-center">
            <div class="pr-5 second-step">
              ...
              <h3 class="text-dark">select the property.</h3>
              <p class="text-black">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            </div>
          </div>
