...
$sql=$conn->query("select * from advertisement where num='$num'");
  ...
  $rest=$conn->query("select * from owner where num='$num'");
  if($rest->num_rows >0)
  {
...
<?php
  ...
  echo '<tr><td colspan="2"><button onclick="myfunction()" class="login">Print</button></td></tr>';
...
if($catno=='1')
{
echo'<tr><td colspan="2"><a href="admin_home3.php?id='.$no.'">back to home</a></td>';
}
else if($catno=='3')
{
  echo'<tr><td colspan="2"><a href="renter_home3.php?id='.$no.'">back to home</a></td>';

}
else
{
  echo'<tr><td colspan="2"><a href="owner_home3.php?id='.$no.'">back to home</a></td>';
}
?>
</table>
</body>
