...
if($catno=='1')
{
echo'<tr><td><a href="admin_home3.php?id='.$no.'">back to home</a></td>';
}
else if($catno=='3')
{
  echo'<tr><td><a href="renter_home3.php?id='.$no.'">back to home</a></td>';

}
else
{
  echo'<tr><td><a href="owner_home3.php?id='.$no.'">back to home</a></td>';
}
?>
      </table>
</body>
