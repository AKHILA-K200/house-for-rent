...
<?php
 ...
 $d2=$_GET['name'];
  ...
  <center>  <center>
    ...
    <tr><center>
  <th colspan="5"><center><b>OWNERS REPORT  </b></center>
  </th></center>
 </tr>
...
$ow=0;
$rr=0;
        $sql=$conn->query("select * from owner where apornot='1' and odate>='$d1' and odate<='$d2' and ora='o'");
      if($sql->num_rows >0)
      {
        ...
        
  {
   ...
   echo'<tr><td>Total no.of owners:'.$ow.'</td><td></td></tr>';
