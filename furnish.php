...
<td><center><img src="images/hfr3.jpeg" height="100" width="100">
  ...
  <td cellspacing="3">
   ...
   echo'<a href="flats.php?id='.$userid.'">Flats</a>';
     <?php echo'<a href="search.php?id='.$userid.'">Search</a>';?>
    <a href="logout.php">LOGOUT</a>
    <center>
    </tr>
<?php
    $sql=$conn->query("select * from advertisement,address where apornot='1' and cno is null and fy='ful' and advertisement.no=address.no");
    if($sql->num_rows >0)
    {
      echo'<form>';
